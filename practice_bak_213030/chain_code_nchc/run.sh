...
#   gb200-rack1, gb200-rack2, gb200-dev; H200:16gpus
...
if [ -z "$CLUSTER" ] \
   ...
   && command -v sinfo  >/dev/null 2>&1; then
    ...
    _RUNSH_CANDIDATES="${PARTITION_CANDIDATES:-GB200:gb200 GB200:gb200-full GB200:gb200-rack1 GB200:gb200-rack2 GB200:gb200-dev H200:16gpus}"
...
# CHAIN_PRESUBMIT_DEP: run.sh has no direct sbatch submission path; the
# dependency-successor resubmit skip is handled by submit_dispatcher.sh.
