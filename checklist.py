#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""checklist.py — Edit11_Krank5600 重要紀錄/狀態檔 checklist 即時生成器.
...
def build(stats):
    ...
    # ---- 檔頭 ----
    a("# " + "=" * (LINE_W - 2))
    a("# Edit11_Krank5600 重要紀錄/狀態檔 checklist")
    a("# " + "-" * (LINE_W - 2))
...
def main(argv=None):
    ap = argparse.ArgumentParser(description="Edit11_Krank5600 checklist 即時生成器")
