...
| chain wrapper | `~/5.Re10595/Edit13_2800ITBLBM/chain_code_local/hill_local_chain.sh` | ✅ 冷/續 + 信號轉發 + exit碼契約 |
| 編譯腳本 | `~/5.Re10595/Edit13_2800ITBLBM/chain_code_local/build_local.sh` | ✅ |
...
cfdq add --np 8 --model V100 --exclusive --chain --name edit11 -- bash chain_code_local/hill_local_chain.sh
```
