#!/bin/bash
# ============================================================================
# jp_lock_selfcheck.sh — Edit12_Krank56002「16gpus@32jp 鎖」一致性深檢 (純唯讀)
# ----------------------------------------------------------------------------
# Edit12 沒有 Edit7 那套 jp-lock 哨兵 (LOCK_JP_PARTITION / jp_lock_status /
# jp_lock_DRIFT.alert)。Edit12 的「鎖」是底下這幾個檔同時成立:
