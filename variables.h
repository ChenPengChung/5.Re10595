...
#define     GILBM2_DEPARTURE_RK4    1      // 2026-06-18 顯式 RK-4 departure (使用者指定 Algorithm2+RK-4)
#endif
...
#define     NDTBIN      1179000   // 2026-06-18 降頻=每 1FTT (SPF=1179000 steps/FTT, 實測 slurm_122886). checkpoint 巢狀於 VTK, NDTVTK==NDTBIN → lcm=1FTT, crash 最多丟~1FTT. 純參數, main.cu 不動
#define     NDTVTK      1179000   // 2026-06-18 降頻=每 1FTT (=NDTBIN, coupled). 降 I/O ~12%→~1% 加速 + 減壞節點 hang; benchmark/watcher 每 1FTT 刷新
...
#define     FTT_STATS_START     25.0    // 統計量開始累積 (2026-06-18: regrid 冷啟 FTT→0, 25 FTT settle 後累積, 使用者指定)
