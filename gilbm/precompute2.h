...
//   WEIGHTS_FOLDED: production fast path; ζ ghost 折進 k_idx/ws_eff, kernel pure MAC.
//   Production default: when USE_GILBM_ALGORITHM2=1, use WEIGHTS_FOLDED unless a build
//   explicitly overrides -DGILBM_ALGO2_STORE=...
...
#if defined(USE_GILBM_ALGORITHM2) && USE_GILBM_ALGORITHM2
#define GILBM_ALGO2_STORE GILBM2_STORE_WEIGHTS_FOLDED
#else
